...
const KNOWN_PROVIDERS: KnownProvider[] = [
  { id: 'openai',       label: 'OpenAI',              defaultBase: 'https://api.openai.com/v1',                          models: ['gpt-5.5', 'gpt-5.4-mini', 'gpt-5.3-codex'],                                   keyHint: 'sk-proj-...' },
  { id: 'anthropic',    label: 'Anthropic',            defaultBase: 'https://api.anthropic.com/v1',                       models: ['claude-opus-4-8', 'claude-sonnet-4-6', 'claude-opus-4-7'],               keyHint: 'sk-ant-...' },
  { id: 'gemini',       label: 'Google Gemini',        defaultBase: 'https://generativelanguage.googleapis.com/v1beta/openai', models: ['gemini-3.1-pro-preview', 'gemini-3.5-flash', 'gemini-3.1-flash-lite'],                               keyHint: 'AIza...' },
  { id: 'kimi',         label: 'Moonshot AI (Kimi)',   defaultBase: 'https://api.moonshot.cn/v1',                         models: ['kimi-k2.6', 'kimi-k2.7-code', 'kimi-k2-thinking'],                                   keyHint: 'sk-...' },
  { id: 'deepseek',     label: 'DeepSeek',             defaultBase: 'https://api.deepseek.com/v1',                        models: ['deepseek-v4-pro', 'deepseek-v4-flash', 'deepseek-chat', 'deepseek-reasoner'],                                     keyHint: 'sk-...' },
  { id: 'xai',          label: 'xAI (Grok)',           defaultBase: 'https://api.x.ai/v1',                                models: ['grok-4.3', 'grok-4.20-0309-reasoning'],              keyHint: 'xai-...' },
  { id: 'mistral',      label: 'Mistral',              defaultBase: 'https://api.mistral.ai/v1',                          models: ['mistral-medium-2604', 'mistral-large-2512', 'mistral-small-2603'],              keyHint: '...' },
  { id: 'minimax',      label: 'MiniMax',              defaultBase: 'https://api.minimaxi.com/v1',                        models: ['MiniMax-M3', 'MiniMax-M2.7'],              keyHint: '...' },
  { id: 'qwen',         label: 'Qwen (千问)',          defaultBase: 'https://api.qwen.ai/v1',                             models: ['qwen3.7-max', 'qwen3.7-plus', 'qwen3.6-flash'],              keyHint: 'sk-...' },
  { id: 'glm',          label: 'Z.AI (GLM)',           defaultBase: 'https://api.z.ai/v1',                                models: ['glm-5.2', 'glm-5.1', 'glm-5v-turbo'],              keyHint: '...' },
